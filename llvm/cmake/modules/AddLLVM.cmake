...
function(process_llvm_pass_plugins)
  ...
  if(ARG_GEN_CONFIG)
      ...
      foreach(llvm_extension ${LLVM_STATIC_EXTENSIONS})
        get_property(llvm_plugin_deps TARGET ${llvm_extension} PROPERTY LINK_LIBRARIES)
        # Extension at least require itself.
        file(APPEND "${ExtensionDeps}.tmp" "{\"${llvm_extension}\", {\"${llvm_extension}\",")
        ...
        endforeach()
        # Mandatory trailing null, because the number of RequiredLibraries differs betwwen extensions.
        file(APPEND "${ExtensionDeps}.tmp" "nullptr}},\n")
      endforeach()
