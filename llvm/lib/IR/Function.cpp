...
void Argument::removeAttrs(const AttrRemover &B) {
  AttributeList AL = getParent()->getAttributes();
...
void Function::removeFnAttrs(const AttrRemover &Attrs) {
...
void Function::removeRetAttrs(const AttrRemover &Attrs) {
...
void Function::removeParamAttrs(unsigned ArgNo, const AttrRemover &Attrs) {
  AttributeSets =
