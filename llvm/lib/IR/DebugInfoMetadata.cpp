...
#define DEFINE_GETIMPL_STORE_N(CLASS, ARGS, OPS, NUM_OPS)                      \
  ...
  DISubrange::DISubrange(LLVMContext &C, StorageType Storage, ArrayRef<Metadata *> Ops)
...
DIEnumerator::DIEnumerator(LLVMContext &C, StorageType Storage, const APInt &Value,
...
DISubroutineType::DISubroutineType(LLVMContext &C, StorageType Storage, DIFlags Flags,
...
DICompileUnit::DICompileUnit(LLVMContext &C, StorageType Storage, unsigned SourceLanguage,
...
DISubprogram::DISPFlags DISubprogram::toSPFlags(bool IsLocalToUnit, bool IsDefinition,
                             bool IsOptimized,
                             unsigned Virtuality,
...
DILexicalBlockBase::DILexicalBlockBase(LLVMContext &C, unsigned ID, StorageType Storage,
                     ArrayRef<Metadata *> Ops) : DILocalScope(C, ID, Storage, dwarf::DW_TAG_lexical_block, Ops) {}
...
DINamespace::DINamespace(LLVMContext &Context, StorageType Storage, bool ExportSymbols,
              ArrayRef<Metadata *> Ops)
...
DICommonBlock::DICommonBlock(LLVMContext &Context, StorageType Storage, unsigned LineNo,
                ArrayRef<Metadata *> Ops)
...
DITemplateTypeParameter::DITemplateTypeParameter(LLVMContext &Context, StorageType Storage,
...
DIVariable::DIVariable(LLVMContext &C, unsigned ID, StorageType Storage, signed Line,
             ArrayRef<Metadata *> Ops, uint32_t AlignInBits)
...
DIObjCProperty::DIObjCProperty(LLVMContext &C, StorageType Storage, unsigned Line,
