...
bool llvm::attributesPermitTailCall(const Function *F, const Instruction *I,
  ...
  SmallAttrBuilder CallerAttrs(F->getContext(), F->getAttributes(), AttributeList::ReturnIndex);
  SmallAttrBuilder CalleeAttrs(F->getContext(), cast<CallInst>(I)->getAttributes(),
